...
#/home/admin1/PycharmProjects/pythonProject3/.venv/bin/python /home/admin1/.config/JetBrains/PyCharmCE2024.2/scratches/scratch_4.py 
	...
	#6: Exit
#Enter your choice: 1
#Enter the main string: Data Structure
#Word with longest length is:  Structure
#Length of longest string is:  9
#	1: To display word with longest length
#	2: To determine the frequency of occurrence of particular character in the string
#	3: To check whether given string is palindrome or not
#	4: To display index of first appearance of the substring
...
#	6: Exit
#Enter your choice: 4
#Enter the main string: butterfly
#Enter the substring: butter
#First appearance of the substring is at index:  0
#	1: To display word with longest length
#	2: To determine the frequency of occurrence of particular character in the string
#	3: To check whether given string is palindrome or not
#	4: To display index of first appearance of the substring
...
#	6: Exit
#Enter your choice: 5
#Enter the main string: malayalam
#malayalam : 1
#	1: To display word with longest length
#	2: To determine the frequency of occurrence of particular character in the string
#	3: To check whether given string is palindrome or not
